...
from slack_api import getMessages,send_message
...
def run():
    ...
    out_text = tokenizer.decode(chain(*personality))
    send_message(out_text,slack_token=args.slack_token,channelId=args.channelId)

    history = []
    raw_text = ""
    while True:
        raw_text = getMessages(slack_token=args.slack_token,channelId=args.channelId)
        while raw_text=="":
            raw_text = getMessages(slack_token=args.slack_token,channelId=args.channelId)
